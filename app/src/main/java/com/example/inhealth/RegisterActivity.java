                ...
                if(username.length()==0 || email.length()==0 || password.length()==0 || confirm.length()==0){
                    ...
                    if(password.compareTo(confirm)==0){
                        if(isValid(password)){
                            ...
                            Toast.makeText(getApplicationContext(),"Password harus mengandung minimal 8 karakter, mengandung huruf, angka, dan simbol",Toast.LENGTH_SHORT).show();
                        }
                    }else{
                        Toast.makeText(getApplication(),"Password dan Konfirmasi belum sama", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
