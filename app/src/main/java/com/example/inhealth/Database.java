...
public class Database extends SQLiteOpenHelper {
    ...
    public ArrayList getOrderData(String username) {
        ...
        if (c.moveToFirst()) {
            do {
                arr.add(c.getString(1)+"Rp"+c.getString(2)+"Rp"+c.getString(3)+"Rp"+c.getString(4)+"Rp"+c.getString(5)+"Rp"+c.getString(6)+"Rp"+c.getString(7)+"Rp"+c.getString(8));
            } while (c.moveToNext());
        }
        db.close();
        return arr;
