        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(db.checkAppointmentExist(username,title+" => " + fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    Toast.makeText(getApplicationContext(), "Appointment Telah Dibooking", Toast.LENGTH_LONG).show();
                }else{
                    ...
                    Toast.makeText(getApplicationContext(), "Proses Booking Janji Temu Anda Telah Berhasil", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(BookAppointmentActivity.this,NotificationsActivity.class));
                }
            }
        });
    }
